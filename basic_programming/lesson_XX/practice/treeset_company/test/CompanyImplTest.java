...
class CompanyImplTest {
    ...
    void removeEmployee() {
        ...
        Assertions.assertNull(company.removeEmployee(102)); // дважды не можем удалить
        Assertions.assertNull(company.findEmployee(102)); // не можем найти после удаления
        company.printEmployees();
    }
    ...
    void findEmployee() {
        ...
        Assertions.assertNull(company.findEmployee(105));
    }
