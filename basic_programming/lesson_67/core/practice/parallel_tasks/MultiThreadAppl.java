...
//        task.run(); // это запуск второго thread
        ...
        MyTaskImplements task = new MyTaskImplements("Parallel One ", MAX); // создали задачу

        Thread thread1 = new Thread(task); // создали новый поток и передали ему эту задачу
